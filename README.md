...
<dataset>_config.ini files include the metadata of CIT4DNN, such as CIT parameters and VAE hyperparameters. Other files in this directory contain details about the target densities.
...
Four files are generated by the script in the [Config](https://github.com/less-lab-uva/CIT4DNN/tree/main/Config) directory for each target density.
...
- boundaries_z\<factors\>\_p\<levels\>\_\<target density tag\>\_i.txt and boundaries_z\<factors\>_p\<levels\>_\<levels\>_o.txt: These files include the radial boundaries of the inner and outer shell respectively.
