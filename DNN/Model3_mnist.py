...
def Model3_mnist(input_tensor=None, train=False):
    nb_classes = 10
    ...
    if train:
        ...
        # save model
        model.save_weights('./Model3_mnist.h5')
        score = model.evaluate(x_test, y_test, verbose=0)
        print('\n')
        print('Overall Test score:', score[0])
        print('Overall Test accuracy:', score[1])
    else:
        model.load_weights('./Model3_mnist.h5')
        print('Model3_mnist loaded')

    return model


if __name__ == '__main__':
    Model3_mnist(train=True)
