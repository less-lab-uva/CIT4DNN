...
def Model2_mnist(input_tensor=None, train=False):
    nb_classes = 10
    ...
    if train:
        ...
        # save model
        model.save_weights('./Model2_mnist.h5')
        ...
        model.load_weights('./Model2_mnist.h5')
        print('Model2_mnist loaded')

    return model


if __name__ == '__main__':
    Model2_mnist(train=True)
